...
export class TermsOfServiceComponent {
  ...
  termsContent = `
    ...
    <ul>
      ...
      <li><p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Dynasty Basketball Trader.</p></li>
      ...
      <li><p><strong>Website</strong> refers to Dynasty Basketball Trader, accessible from <a href="http://www.dynastybasketballtrader.com" rel="external nofollow noopener" target="_blank">www.dynastybasketballtrader.com</a></p></li>
    ...
    <ul>
      <li>By email: dynastybasketballtrader&#64;gmail.com</li>
    </ul>
  `;
}
